...
with st.expander("📘 Tips: Properties, Sources & How to Adjust", expanded=False):
    st.markdown(
        ...
        *Note:* Many entries in the large catalog start from **representative anchor values**. For flight work, replace with exact supplier/NASA/ESA data for the specific grade, weave, and thickness.
        """
    )
